...
keystone.init({
	...
	'auth': true,
	'user model': 'User',
	'cookie secret': process.env.COOKIE_SECRET || 'mrmind',
...
keystone.set('email locals', {
	...
	host: (function() {
		...
		if (keystone.get('env') === 'production') return 'http://ai.mrtalk.co.kr';
		return (keystone.get('host') || 'http://localhost:') + (keystone.get('port') || '80');
	})()
});
